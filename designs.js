  jQuery(function($) {
    ...
    //@description These variables are used for the color Palettes
    const colorPalettes = $('#color-Palettes');
    let colorPicker = $('#defaultPalette');
    ...
    //@description Handles the Palettes switching
    colorPalettes.on('click', 'input[type=radio]', function(e) {
      //@description Switch the colorPicker to be equal to the chosen palette.
      colorPicker = $(e.target).siblings('input');
    });
